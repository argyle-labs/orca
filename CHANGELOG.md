...
### Bug Fixes
- fix(pod): re-spawn mesh :12002 TLS listener; reject legacy peer.<id> CN
- fix(pod): keep mDNS responder alive past startup; fix install.sh subcommand
...
All notable stable releases are documented here.
Pre-release notes live in the GitHub release body for each RC tag.

---

## [v0.0.2] — 2026-05-10

Initial public stable release. Core orca daemon, MCP server, CLI surfaces,
agent backend, secrets domain v1 (inline encrypted DB), install script,
and self-update mechanism.
