...
impl Retention {
    ...
    pub fn keep_last(n: u32) -> Self {
        Self { keep_last: Some(n), ..Self::default() }
    }
...
impl BackupTarget {
    ...
    pub fn local(path: impl Into<String>) -> Self {
        Self { path: path.into(), backing: BackupBacking::Local, provision_if_missing: true }
    }
...
mod tests {
    ...
    fn unbounded_retention_is_flagged() {
        assert!(Retention { keep_last: None, ..Retention::default() }
            .keep_last
            .is_none());
    ...
    fn local_target_needs_no_mount_network_does() {
        ...
        let nfs = BackupTarget {
            ...
            backing: BackupBacking::Nfs { server: "10.0.0.1".into(), export: "/export/backups".into() },
