...
export function pointerToWorld(clientX: number, clientY: number, rect: { left: number; top: number }, cam: Cam): { x: number; y: number } {
  return {
...
export function fitViewParams(viewWidth: number, viewHeight: number, wW: number, wH: number): { targetZoom: number; targetX: number; targetY: number } {
...
export function focusNodeParams(viewWidth: number, viewHeight: number, node: TableNode, currentZoom: number, zoomOverride?: number): { targetX: number; targetY: number; targetZoom: number } {
...
export function zoomByParams(viewWidth: number, viewHeight: number, cam: Cam, factor: number): { targetX: number; targetY: number; targetZoom: number } {
