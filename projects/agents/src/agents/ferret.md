...
See `~/brain/ai/claude/DELEGATION.md` for the full KB and specialist routing table. For canonical type and source locations per project, see `~/brain/ai/claude/CANONICAL_SOURCES.md`.
...
- See `~/brain/ai/claude/TOOL_RULES.md` for the standard modification policy (one at a time, confirm each, verify after).
