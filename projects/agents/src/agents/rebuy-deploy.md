---
name: rebuy-deploy
description: "[MIGRATE TO REBUY ADAPTER] Source of truth: ~/.orca/legacy-adapters/adapters/rebuy/agents/rebuy-deploy.md. Rebuy deployment specialist — Bitbucket Pipelines, Kubernetes, tagging, release workflows."
