...
See `~/brain/ai/claude/CODING_RULES.md` for shared coding discipline (read-first, validation, scope, conventions). See `~/brain/ai/claude/DELEGATION.md` for the full routing table.

## Rules

- If the request is ambiguous, ask one focused question rather than guessing.
- See `~/brain/ai/claude/CODING_RULES.md` for shared coding discipline.
