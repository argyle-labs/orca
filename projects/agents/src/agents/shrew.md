...
Consult KB agents for project-specific test conventions (frameworks, patterns, DatabaseManager usage). See `~/brain/ai/claude/DELEGATION.md` for the full routing table. For canonical type and schema locations per project, see `~/brain/ai/claude/CANONICAL_SOURCES.md`.
