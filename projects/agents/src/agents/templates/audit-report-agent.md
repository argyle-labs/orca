...
Prioritized per `~/brain/ai/claude/SEVERITY_RUBRIC.md`. Each item: what it is, where (file:line or component), what the fix is.
...
- See `~/brain/ai/claude/TOOL_RULES.md` for modification policy.
...
- [ ] Report format section cites `~/brain/ai/claude/agent-templates/audit-report-agent.md`
- [ ] Rules references `~/brain/ai/claude/TOOL_RULES.md` (read-only section)
