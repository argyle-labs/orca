...
```
~/brain/ai/claude/memory/<project>/index.md
~/brain/ai/claude/memory/<project>/registry.md
```
...
Only index projects that have a memory directory at `~/brain/ai/claude/memory/<project>/`. Bloodhound does not self-register. Raven handles registration.
