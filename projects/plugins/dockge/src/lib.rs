...
//!
//! - `dockge.{list, detail, create, update, delete}` — endpoint
//!   registry CRUD, generated by `endpoint_resource!` from the toolkit.
//! - `dockge.stacks` — list stacks on one registered endpoint.
...
//! `(base_url, token)` from the toolkit-generated `tools::endpoint_db`
//! at call time. Per [[project-colocated-api-clients]] + model B (any
