---
name: boar
description: "[MIGRATE TO REBUY ADAPTER] Source of truth: ~/.orca/legacy-adapters/adapters/rebuy/agents/boar.md. BOD development environment operations via the carl CLI."
tools: Bash, Read
model: inherit
color: red
---
