...
```
projects/frontend/src/routes/systems/[id]/+page.ts     ← load function
projects/frontend/src/routes/systems/[id]/+page.svelte ← component
```
...
```typescript
// projects/frontend/src/routes/systems/[id]/+page.ts
...
```
projects/frontend/src/lib/client/sdk.gen.ts   ← one typed fn per #[orca_tool] endpoint
...
projects/frontend/src/lib/client/           Generated typed API client — *.gen.ts (never edit manually)
```
